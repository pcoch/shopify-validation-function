...
var require_country_code_lookup = __commonJS({
  "node_modules/country-code-lookup/index.js"(exports, module) {
...
// extensions/cart-checkout-validation/src/run.ts
var lookup = require_country_code_lookup();
function run(input) {
  ...
  const errors = input.cart.lines.filter((line) => {
    const cantShipTo = JSON.parse(line.merchandise.product.metafield?.value);
